  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-7xl gradient-title mb-6">
          Your Space to take Notes. <br /> About anything & everything.
        </h1>
      ...
      {/* CTA Section */}
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-purple-200 to-amber-50">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-purple-900 mb-6">
              Start Taking Notes on Your Journey Today
            </h2>
